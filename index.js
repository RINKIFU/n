...
start(`1`,`Connecting...`)
  ...
  oka.sendMessage('6285730672259' + "@s.whatsapp.net", { text: `*halo Rizalz*
  Telah Terhubung!!
  
  *_Jangan Lupa Untuk Subscribe Channel Rizal Desta Untuk Mendapatkan Info Terbaru._*
  
  *www.youtube.com/@RizalDesta.*` });
  success(`1`,`[■■■■■■■■■■■■■■■] Connected`) 
}
