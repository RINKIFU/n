...
const reply = (teks) => {
return okta.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `halo saya ${botname}🌹`,"body": `Selamat ${ucapanWaktu} kak ${pushname}`, mediaType: 1, renderLargerThumbnail: true, "previewType": "PHOTO","thumbnailUrl": 'https://telegra.ph/file/c31ea54c441377970d979.jpg',"thumbnail": thumb,"sourceUrl": `https://chat.whatsapp.com/JfUTLVolBt70aMCnIrp0wz`}}}, { quoted:m})} 
        ...
        document: fs.readFileSync('./baseoka/media/doc.pdf'), 
                    ...
                    contextInfo: {
                        externalAdReply: {
                            ...
                            body: `${ownername}`,
                            thumbnailUrl: 'https://telegra.ph/file/c31ea54c441377970d979.jpg',
...
const fkontak = { key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { 'contactMessage': { 'displayName': `ᴘʀᴏᴊᴇᴄᴛ rizal desta ❄️`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;TaaOfc,;;;\nFN:${pushname},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': { url: 'https://telegra.ph/file/c31ea54c441377970d979.jpg' }}}}
...
var taaofc = [
 ...
 '..',
 '...',
 'ᴘʀᴏᴊᴇᴄᴛ rizal desta ❄️Loading selesai!'
]
...
title: botname,
body: `ᴘʀᴏᴊᴇᴄᴛ rizal desta ❄️`,
thumbnail: thum,
mediaType: 1,
thumbnailUrl: "",
renderLargerThumbnail: true,
sourceUrl: `https://chat.whatsapp.com/JfUTLVolBt70aMCnIrp0wz`,
}}}, { quoted: fkontak })
...
addBesi(m.sender, c)
addDm(m.sender, d)
bufas = "https://telegra.ph/file/c31ea54c441377970d979.jpg"
 ...
 *_https://chat.whatsapp.com/JfUTLVolBt70aMCnIrp0wz_*
•-------------------------------------------------•`
                        }
                    },
...
reply(`
┏❏═┅═━–〈 Iɴғᴏ
┆ ☂︎ 𝙱𝚘𝚝 𝙽𝚊𝚖𝚎 : ᴘʀᴏᴊᴇᴄᴛ rizal desta ❄️
┆ ☂︎ 𝚄𝚜𝚎𝚛 : ${pushname}
┆ ☂︎ 𝙿𝚛𝚎𝚖𝚒𝚞𝚖 : ${isPrem ? '✅' : '❎'}
┆ ☂︎ 𝚃𝚊𝚗𝚐𝚐𝚊𝚕: ${hariini}
┆ ☂︎ 𝙹𝚊𝚖: ${time} WIB❄️
...
▭▬▭▬▭▬▭▬▭▬▭▬▭▬
「 *BOT INFO* 」
⭔Nama Creator : *rizaldev*
⭔Nomor Creator : *@${owned.split("@")[0]}*
⭔Nama Script : *ᴘʀᴏᴊᴇᴄᴛ rizal desta ❄️*
⭔Versi Script : *2.0*
⭔Botz Name : *ᴘʀᴏᴊᴇᴄᴛ rizal desta ❄️*
⭔Type Baileys : *Case*
▭▬▭▬▭▬▭▬▭▬▭▬▭▬
...
⭔Versi Bot : *2.3*
⭔Botz Name : *ᴘʀᴏᴊᴇᴄᴛ rizal desta ❄️*
⭔Nomor Bot : *wa.me/62857306722596*
⭔Type Baileys : *Case*
⭔Source Code : *${okta}*
...
https://chat.whatsapp.com/${response}
       `;
            okta.sendMessage(
              ...
              {
                text: teks,
                mentions: await okta.parseMention(teks),
              },
              { quoted: m }
            );
          } catch {
...
"inviteExpiration": `MY NAME rizaldev${buttonkal}`,
"groupName": `MY NAME rizaldev${buttonkal}`,
"caption": `${buttonkal}`,
...
okta.sendMessage(from, { react: { text: '♻️', key: m.key }})

if (!text) return reply(`Kirim Judul Lagu ❗`)
const oktaplaymp3 = require('./Media/lib/ytdl2')
let yts = require('youtube-yts')
        let search = await yts(text)
        let anup3k = search.videos[0]
const pl= await oktaplaymp3.mp3(anup3k.url);
reply('Mengirim... ');
await okta.sendMessage(m.chat,{
...
await loading()
m.reply(`¥ *Price Sewa Bot ᴘʀᴏᴊᴇᴄᴛ rizal desta ❄️* €
...
const oktavidoh = require('./Media/lib/ytdl2')
if (args.length < 1 || !isUrl(text) || !oktavidoh.isYTUrl(text)) reply(`Kirim Link Video YouTube ❗`)
const vid=await oktavidoh.mp4(text)
const ytc=`
Judul: ${vid.title}
Tanggal: ${vid.date}
Durasi: ${vid.duration}
...
case 'p':
    ...
    okta.sendMessage(from, { react: { text: '❌', key: m.key }})
...
console.log(`[${new Date().toLocaleTimeString()}] Spam (SMS) BY ᴘʀᴏᴊᴇᴄᴛ rizal desta ❄️`);
});
}
...
okta.sendMessage(from, {image: { url: result }, caption: 'ᴘʀᴏᴊᴇᴄᴛ rizal desta ❄️ SUKSES'},{quoted:m})
}
break
//=================================================
case 'cecanindo': {
...
case 'setppgroup':
            ...
            case 'setppgc':
                ...
                if (args[0] == 'full') {
                    ...
                    var memeg = await okta.updateProfilePicture(m.chat, {
                        url: medis
                    })
                    fs.unlinkSync(medis)
                    reply(mess.done)
...
//=================================================
case "listpanel": {
const text12 = `SEWA PANEL RIZALDEV HOSTING ⚡
...
MINAT CHAT : 
https://wa.me/6285730672259`
okta.sendMessage(from, { image: { url: `https://telegra.ph/file/77bd4ab69e006ca36edda.jpg` }, caption: text12, fileLength: 10, contextInfo: { mentionedJid:[sender], forwardingScore: 9999, isForwarded: true }}, { quoted: m })
}
break
/////=================///////////
case "disney": {
const text12 = `*☰ DISNEY + PREM*
...
*NOTE* : 
✅ Plan *PREMIUM BUKAN BASIC*
✅ _1 Akun Sharing 5 User_
✅ _Screen Limit : 3 User_
✅ _Full Garansi_
✅ _Akun Dari Admin_
...
`
okta.sendMessage(from, { image: { url: `https://telegra.ph/file/02005674c0f0bb223db76.jpg` }, caption: text12, fileLength: 10, contextInfo: { mentionedJid:[sender], forwardingScore: 9999, isForwarded: true }}, { quoted: m })
}
break
////=========////
case "pyment": {
const text12 = `
*PEMBAYARAN RIZAL-DEV*
...
`
okta.sendMessage(from, { image: { url: `https://telegra.ph/file/059d7e3f6810f01459ade.jpg` }, caption: text12, fileLength: 10, contextInfo: { mentionedJid:[sender], forwardingScore: 9999, isForwarded: true }}, { quoted: m })
}
break
//////=============\\\\\
case "dana": {
const text12 = `PYMENT DANA RIZAL-DEV ⚡
*PEMBAYARAN RIZAL-DEV*
...
`
okta.sendMessage(from, { image: { url: `https://telegra.ph/file/28098d6c0ecbf93ce5325.jpg` }, caption: text12, fileLength: 10, contextInfo: { mentionedJid:[sender], forwardingScore: 9999, isForwarded: true }}, { quoted: m })
}
break
/////----_____________///

case "pulsa": {
const text12 = `PYMENT PULSA RIZAL-DEV ⚡
*PEMBAYARAN RIZAL-DEV*
...
`
okta.sendMessage(from, { image: { url: `https://telegra.ph/file/df9a0c23078e484dd281d.jpg` }, caption: text12, fileLength: 10, contextInfo: { mentionedJid:[sender], forwardingScore: 9999, isForwarded: true }}, { quoted: m })
}
break
//////=============\\\\\
case "gopay": {
const text12 = `PYMENT GOPAY RIZAL-DEV ⚡
*PEMBAYARAN RIZAL-DEV*
...
`
okta.sendMessage(from, { image: { url: `https://telegra.ph/file/f7546a5e6420dc38fb6f9.jpg` }, caption: text12, fileLength: 10, contextInfo: { mentionedJid:[sender], forwardingScore: 9999, isForwarded: true }}, { quoted: m })
}
break
/////----_____________///
case 'jadwalsholat':
...
fs.unlinkSync(delb)
reply(`ᴘʀᴏᴊᴇᴄᴛ rizal desta ❄️ Sukses Menambahkan Pdf\nCek dengan cara ${prefix}listpdf`)
}
}
break
//=================================================//
...
reply(`ᴘʀᴏᴊᴇᴄᴛ rizal desta ❄️ Sukses delete pdf ${teks}`)
}
}
break
//=================================================//
...
m.reply(`ᴘʀᴏᴊᴇᴄᴛ rizal desta ❄️ Sukses Mengirim Pesan Pdf Ke ${m.quoted.sender}`)
}
}
break
//=================================================//
...
fs.unlinkSync(delb)
reply(`ᴘʀᴏᴊᴇᴄᴛ rizal desta ❄️ Sukses Menambahkan zip\nCek dengan cara ${prefix}listzip`)
}
}
break
//=================================================//
...
reply(`ᴘʀᴏᴊᴇᴄᴛ rizal desta ❄️ Sukses delete zip ${teks}`)
}
}
break
//=================================================//
...
m.reply(`ᴘʀᴏᴊᴇᴄᴛ rizal desta ❄️ Sukses Mengirim Pesan Zip Ke ${m.quoted.sender}`)
}
}
break
//=================================================//
...
fs.unlinkSync(delb)
reply(`ᴘʀᴏᴊᴇᴄᴛ rizal desta ❄️ Sukses Menambahkan apk\nCek dengan cara ${prefix}listapk`)
}
}
break
//=================================================//
...
reply(`ᴘʀᴏᴊᴇᴄᴛ rizal desta ❄️ Sukses delete Apk ${teks}`)
}
}
break
//=================================================//
...
m.reply(`ᴘʀᴏᴊᴇᴄᴛ rizal desta ❄️ Sukses Mengirim Pesan Apk Ke ${m.quoted.sender}`)
}
}
break
//=================================================//
...
fs.unlinkSync(delb)
reply(`ᴘʀᴏᴊᴇᴄᴛ rizal desta ❄️ Sukses Menambahkan Audio\nCek dengan cara ${prefix}listvn`)
}
break
//=================================================//
case 'delvn':{
...
reply(`ᴘʀᴏᴊᴇᴄᴛ rizal desta ❄️ Sukses delete vn ${text}`)
}
break
//=================================================//
case 'listvn':{
...
await loading()
 ...
 m.reply(`ᴘʀᴏᴊᴇᴄᴛ rizal desta ❄️ Sukses Mengirim Pesan Ke ${m.quoted.sender}`)
}
break
//=================================================//
case 'listmsg': {
...
case 'opentime':
                ...
                setTimeout(() => {
                    ...
                    okta.groupSettingUpdate(m.chat, 'not_announcement')
                    reply(open)
                }, timer)
                break
///@#####//
case 'closetime':
                ...
                setTimeout(() => {
                    ...
                    okta.groupSettingUpdate(m.chat, 'announcement')
                    reply(close)
                }, timer)
                break
///######///
...
m.reply(`*ᴘʀᴏᴊᴇᴄᴛ rizal desta ❄️ Sukses mengirim status whatsapp ke ${pengguna.length} Orang Yang Ada Di database*`)
break
//=================================================
case "buatswimage":{
if (!isCreator) return m.reply('*Khusus Premium*')
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
 ...
 okta.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c31ea54c441377970d979.jpg' }, caption:`Waktu Habis\nJawaban:  ${tebaklagu[m.sender.split('@')[0]]}\n\nIngin bermain? Ketik tebak lagu`},{quoted:m}) 
 delete tebaklagu[m.sender.split('@')[0]]
 }
